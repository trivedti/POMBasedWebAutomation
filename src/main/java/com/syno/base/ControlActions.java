...
public abstract class ControlActions {
	...
	public static int genericNumber, linkedTestCaseID;
	String testCaseIDDetail;
	...
	public boolean waitForElementText(int seconds,String textOfElement,String locator) {
	...
	public boolean waitForElement(int seconds,String locator) {
		WebDriverWait wait = new WebDriverWait(getDriver(), seconds);
